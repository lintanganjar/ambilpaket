    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Pengajuan Upgrade Kemitraan Agen
                </h1>
            </div>
            <div class="sm:flex">
                            ...
                            @foreach ($data as $agen)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button data-modal-target="detail-kemitraan-modal"
                                            data-modal-toggle="detail-kemitraan-modal" type="button"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div
                                                    ...
                                                    <h3 class="text-xl font-semibold dark:text-white">
                                                        Detail Pengajuan Upgrade Kemitraan Agen
                                                    </h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-toggle="detail-kemitraan-modal">
                                                ...
                                                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                    @include('pages.superadmin.agen.upgrade-kemitraan.detail')
                                                </div>
                                                <!-- Modal footer -->
                                                <div
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus pengajuan upgrade kemitraan ini?</h3>
                    <a href="#"
