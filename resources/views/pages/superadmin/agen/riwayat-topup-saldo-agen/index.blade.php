    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Riwayat Topup Saldo Agen</h1>
            </div>
            <div class="sm:flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($data as $agen)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $agen->top_up_transactions->create_at }}
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ '+62 ' . preg_replace('/(\d{3})(\d{4})(\d{4})/', '$1 $2 $3', $agen->phone_number) }}

                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        Rp{{ number_format($agen->top_up_transactions->amount, 0, ',', '.') }}
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-3 mr-10">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{ $agen->top_up_transactions->payment_method->account_name }}
                                                </div>
                                                <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                    {{ $agen->top_up_transactions->payment_method->bank_name }} -
                                                    {{ $agen->top_up_transactions->payment_method->account_number }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <div class="flex text-xs items-center dark:text-white">
                                            @if ($agen->top_up_transactions->request_status === 'Diterima')
                                                <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>
                                                <span>Diterima</span>
                                            @elseif ($agen->top_up_transactions->request_status === 'Ditolak')
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button data-modal-target="detail-topup-modal"
                                            data-modal-toggle="detail-topup-modal" type="button"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div
                                                    ...
                                                    <h3 class="text-xl font-semibold dark:text-white">
                                                        Detail Riwayat Topup Agen
                                                    </h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-toggle="detail-topup-modal">
                                                ...
                                                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                    @include('pages.superadmin.agen.riwayat-topup-saldo-agen.detail')
                                                </div>
                                                <!-- Modal footer -->
                                                <div
                                                    ...
                                                    <button type="button" id="cancel-btn"
                                                        data-modal-id="detail-topup-modal"
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus riwayat topup ini?
                    </h3>
                    <a href="#"
