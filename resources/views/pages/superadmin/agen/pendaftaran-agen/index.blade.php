        ...
        <div class="w-full mb-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('superadmin-agen.agen-registration') }}"
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-agen-approval-modal"
                        ...
                        <button type="button" data-modal-target="download-file-agen-approval-modal"
                            data-modal-toggle="download-file-agen-approval-modal"
                            ...
                            @foreach ($dataList as $agen)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="items-center p-4 mr-12 whitespace-nowrap">
                                        ...
                                        <div class="text-xs font-normal text-gray-900 dark:text-white">
                                            {{ ucwords($agen->agen_district_id->name . ', ' . $agen->agen_regency_id->name . ', ' . $agen->agen_province_id->name) }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button type="button" data-modal-target="delete-agen-approval-modal"
                                            data-modal-toggle="delete-agen-approval-modal"
        ...
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.superadmin.agen.pendaftaran-agen.detail')
                </div>
                <!-- Modal footer -->
                <div
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        ...
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.superadmin.agen.pendaftaran-agen.add-form')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus pendaftaran agen ini?</h3>
                    <a href="#"
