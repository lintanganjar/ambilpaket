                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Pengajuan
                                    Top-Up Saldo</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Pengajuan Topup Saldo Agen</h1>
            </div>
            <div class="sm:flex">
                                        ...
                                        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div class="p-6 space-y-2 max-h-96 overflow-y-auto">
                                                    @include('pages.superadmin.agen.topup-saldo.detail')
                                                </div>
                                                <!-- Modal footer -->
                                                <div
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg font-semibold text-gray-900 dark:text-white">Alasan penolakan transaksi
                        top-up</h3>
                    <input type="text" id="first_name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Masukkan disini..." required />
                    <a href="#"
                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-7 py-2.5 text-center mr-2 mt-7 dark:focus:ring-red-800">
                        Oke
                    </a>
