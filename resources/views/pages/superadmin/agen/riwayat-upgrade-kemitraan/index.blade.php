...
@section('content')
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('superadmin-agen.data-agen') }}"
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Riwayat
                                    Upgrade Kemitraan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Riwayat Upgrade Kemitraan Agen
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form action="#" method="GET" class="hidden lg:block">
                        <label for="courier-search" class="sr-only">Search</label>
                        <div class="relative mt-1 lg:w-96">
                            ...
                            <input type="text" name="search" id="courier-search"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-xs rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Cari">
                        </div>
                    </form>
                </div>
                <div class="flex justify-end items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    <button type="button" data-modal-target="download-file-courier-modal"
                        data-modal-toggle="download-file-courier-modal"
                            ...
                            @foreach ($data as $agen)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-3 mr-10">
                                            <img class="w-10 h-10 rounded-full hidden lg:block md:block"
                                                src="{{ asset('static/images/users/' . optional($agen)->profile_img ?? 'default-avatar.png') }}"
                                                alt="avatar">
                                            ...
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                ...
                                                <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                    {{ $agen->user_id->email }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $agen->partnership_transactions->create_at }}
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $agen->partnership->name }}

                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        Rp{{ number_format($agen->partnership->price, 0, ',', '.') }}
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-3 mr-10">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{ $agen->partnership_transactions->payment_method->account_name }}
                                                </div>
                                                <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                    {{ $agen->partnership_transactions->payment_method->bank_name }} -
                                                    {{ $agen->partnership_transactions->payment_method->account_number }}
                                                </div>
                                            </div>
                                    </td>
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <div class="flex text-xs items-center dark:text-white">
                                            @if ($agen->status === 'Diterima')
                                                <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>
                                                <span>Diterima</span>
                                            @elseif ($agen->status === 'Ditolak')
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button data-modal-target="detail-riwayat-kemitraan-modal"
                                            data-modal-toggle="detail-riwayat-kemitraan-modal" type="button"
                                        ...
                                        <button type="button" data-modal-target="delete-agen-modal"
                                            data-modal-toggle="delete-agen-modal"
                                    ...
                                    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                                        id="detail-riwayat-kemitraan-modal">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div
                                                    ...
                                                    <h3 class="text-xl font-semibold dark:text-white">
                                                        Detail Riwayat Upgrade Kemitraan Agen
                                                    </h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-toggle="detail-riwayat-kemitraan-modal">
                                                ...
                                                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                    @include('pages.superadmin.agen.riwayat-upgrade-kemitraan.detail')
                                                </div>
                                                <!-- Modal footer -->
                                                <div
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="delete-agen-modal">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus riwayat pengajuan upgrade kemitraan ini?</h3>
                    <a href="#"
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto h-modal sm:h-full"
        id="download-file-courier-modal">
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-courier-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
