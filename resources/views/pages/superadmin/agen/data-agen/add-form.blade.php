                ...
                <div class="lg:col-span-10 col-span-12">
                    <div class="relative">
                        <select id="regency_id"
                            ...
                            <option value="1">Kabupaten X</option>
                            <option value="2">Kabupaten Y</option>
                            <option value="3">Kabupaten Z</option>
                        </select>
    ...
    <div class="col-span-3">
        <div
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="lg:col-span-2 col-span-12 lg:flex items-center">
                    <h2 class="text-xs font-medium text-gray-900 dark:text-white">Kemitraan</h2>
                </div>
                <div class="lg:col-span-10 col-span-12">
                    <div class="relative">
                        <select id="partnership_id"
                            class="block px-2.5 pb-1.5 pt-3 w-full text-xs text-gray-900 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-customprimary-500 peer">
                            <option value="" disabled selected>-- Pilih Kemitraan --</option>
                            <option value="1">Kemitraan A</option>
                            <option value="2">Kemitraan B</option>
                            <option value="3">Kemitraan C</option>
                            <option value="4">Kemitraan D</option>
                            <option value="5">Kemitraan E</option>
                        </select>
                        <label for="partnership_id"
