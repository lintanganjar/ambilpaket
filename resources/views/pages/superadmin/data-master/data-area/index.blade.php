        ...
        $dataList = [
            ...
            (object) [
                ...
                'district_coverage' => [
                    (object) [
                        'id' => 8,
                        'name' => 'Kecamatan Cibiru',
                    ],
                    (object) [
                        'id' => 9,
                        'name' => 'Kecamatan Ujung Berung',
                    ],
                    (object) [
                        'id' => 10,
                        'name' => 'Kecamatan Gedebage',
                    ],
                ],
            ],
            (object) [
                'id' => 3,
                'name' => 'Area Surabaya Barat',
                'regency_id' => (object) [
                    'id' => 11,
                    'name' => 'Kota Surabaya',
                ],
                'district_coverage' => [
                    (object) [
                        'id' => 12,
                        'name' => 'Kecamatan Tandes',
                    ],
                    (object) [
                        'id' => 13,
                        'name' => 'Kecamatan Sukomanunggal',
                    ],
                    (object) [
                        'id' => 14,
                        'name' => 'Kecamatan Benowo',
                    ],
                ],
            ],
            (object) [
                'id' => 4,
                'name' => 'Area Medan Utara',
                'regency_id' => (object) [
                    'id' => 15,
                    'name' => 'Kota Medan',
                ],
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('superadmin-data-master.data-area') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Area</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Area</h1>
            </div>
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-area-modal"
                            data-modal-toggle="add-area-modal"
                        ...
                        <button type="button" data-modal-target="download-file-area-modal"
                            data-modal-toggle="download-file-area-modal"
                            ...
                            @foreach ($dataList as $area)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <div class="flex space-x-6 mr-10">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="flex space-x-1 mt-1">
                                                    @foreach ($area->district_coverage as $district)
                                                        <span
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-area-modal"
                                            data-modal-toggle="detail-area-modal"
                                        ...
                                        <button type="button" data-modal-target="delete-area-modal"
                                            data-modal-toggle="delete-area-modal"
        ...
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.superadmin.data-master.data-area.detail')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                    <button type="button" id="edit-btn" data-modal-id="detail-area-modal"
                    ...
                    <button type="button" id="close-btn" data-modal-toggle="detail-area-modal"
                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                    ...
                    <button type="button" id="cancel-btn" data-modal-id="detail-area-modal"
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        ...
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.superadmin.data-master.data-area.add-form')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                    ...
                    <button type="button" data-modal-toggle="add-area-modal"
                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                        <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="delete-area-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus data area ini?</h3>
                    <a href="#"
        ...
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-area-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
