...
@section('content')
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('superadmin-parcel.assignment-history') }}"
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Riwayat Penugasan Kurir
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form action="#" method="GET" class="hidden lg:block">
                        <label for="courier-history-search" class="sr-only">Search</label>
                        <div class="relative lg:w-96">
                            ...
                            <input type="text" name="search" id="courier-history-search"
                ...
                <div class="flex justify-end items-center ml-auto space-x-2 sm:space-x-3">
                    ...
                    <button type="button" data-modal-target="download-file-assignment-history-modal"
                        data-modal-toggle="download-file-assignment-history-modal"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($dataList as $courierAssign)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ ucwords($courierAssign->kurir->name) }}
                                    </td>

                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-assignment-history-modal"
                                            data-modal-toggle="detail-assignment-history-modal"
                                        ...
                                        <button type="button" data-modal-target="delete-assignment-history-modal"
                                            data-modal-toggle="delete-assignment-history-modal"
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="detail-assignment-history-modal">
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.superadmin.paket.riwayat-penugasan-kurir.detail')
                </div>
                <!-- Modal footer -->
                <div
                    ...
                    <button type="button" data-modal-toggle="detail-assignment-history-modal"
                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
    ...
    <!-- Delete parcelAssign Modal -->
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="delete-assignment-history-modal">
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto h-modal sm:h-full"
        id="download-file-assignment-history-modal">
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-assignment-history-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
