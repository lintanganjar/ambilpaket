...
@section('content')
    @php
        $dataList = [
            (object) [
                ...
                'date' => '2024-11-06',
                'detail' => 'Paket dalam perjalanan menuju Jakarta',
            ],
            (object) [
                'id' => 2,
                'parcel_id' => (object) [
            ...
            (object) [
                ...
                'parcel_id' => (object) [
                    'id' => 5,
                    'proof_img' => 'neil-sims.png',
                    'resi_number' => 'RESI03948722',
                    'item_name' => 'Buku Novel',
                ],
                'date' => '2024-11-08',
                'detail' => 'Paket dalam perjalanan menuju Jakarta',
            ],
    ...
    @endphp
    <div
        class="p-4 block sm:flex items-center justify-between lg:mt-1.5 border-b bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('superadmin-parcel.outcoming-parcel') }}"
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Paket Keluar</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="flex items-center max-w-lg mx-auto" onsubmit="return false;">
                        <label for="outcoming-parcel-search" class="sr-only">Search</label>
                        <div class="relative w-96">
                            ...
                            <input type="text" name="search" id="outcoming-parcel-search"
                        ...
                        <button type="submit" data-modal-target="outcoming-parcel-timeline-modal"
                            data-modal-toggle="outcoming-parcel-timeline-modal"
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-outcoming-parcel-modal"
                            data-modal-toggle="add-outcoming-parcel-modal"
                        ...
                        <button type="button" data-modal-target="download-file-outcoming-parcel-modal"
                            data-modal-toggle="download-file-outcoming-parcel-modal"
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($dataList as $outcomingParcel)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-6">
                                            <img class="w-10 h-10 rounded-full hidden lg:block md:block"
                                                src="{{ asset('static/images/users/' . $outcomingParcel->parcel_id->proof_img) }}"
                                                alt="avatar">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{ ucwords($outcomingParcel->parcel_id->resi_number) }}
                                                </div>
                                                <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                    {{ ucwords($outcomingParcel->parcel_id->item_name) }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ date('d F Y', strtotime($outcomingParcel->date)) }}
                                    </td>
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ ucwords($outcomingParcel->detail) }}
                                    </td>
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="outcoming-parcel-timeline-modal">
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    ...
                    @include('pages.superadmin.paket.paket-keluar.detail')
                </div>
                <!-- Modal footer -->
                <div
                    ...
                    {{-- <button type="button" id="close-btn" data-modal-toggle="outcoming-parcel-timeline-modal"
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto h-modal sm:h-full"
        id="download-file-outcoming-parcel-modal">
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-outcoming-parcel-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
