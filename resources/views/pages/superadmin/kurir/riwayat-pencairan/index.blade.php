    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Riwayat Pencairan Saldo Kurir
                </h1>
            </div>
            <div class="sm:flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($data as $kurir)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-2 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $kurir->courier_withdrawal->create_at }}
                                    <td
                                        class="p-4
                                        text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        Rp{{ number_format($kurir->courier_withdrawal->amount, 0, ',', '.') }}
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $kurir->courier_withdrawal->bank_name }}
                                    <td class="p-4 whitespace-nowrap">
                                        <div class="flex text-xs items-center dark:text-white">
                                            @if ($kurir->status === 'Diterima')
                                                <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>
                                                <span>Diterima</span>
                                            @elseif ($kurir->status === 'Ditolak')
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button data-modal-target="pencairan-kurir-modal"
                                            data-modal-toggle="pencairan-kurir-modal" type="button"
                                            data-modal-target="pencairan-kurir-modal"
                                            data-modal-toggle="pencairan-kurir-modal" type="button"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <div
                                                    ...
                                                    <h3 class="text-xl font-semibold dark:text-white">
                                                        Detail Riwayat Pencairan Saldo Kurir
                                                    </h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                                                        data-modal-toggle="pencairan-kurir-modal">
                                                ...
                                                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                    @include('pages.superadmin.kurir.riwayat-pencairan.detail')
                                                </div>
                                                <!-- Modal footer -->
                                                <div
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus riwayat pengajuan
                        pencairan saldo kurir ini?</h3>
                    <a href="#"
