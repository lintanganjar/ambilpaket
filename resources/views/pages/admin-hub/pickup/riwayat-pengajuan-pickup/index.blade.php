...
@section('content')
    {{-- @php
        $dataList = [
            ...
            (object) [
                ...
                'reason' => 'Permintaan pickup untuk produk makanan ringan.',
                'status' => 'Ditolak',
            ],
            (object) [
                'id' => 3,
                'customer_umkm_id' => (object) [
                    'id' => 3,
                    'company_name' => 'Toko Pangan Sehat',
                    'product_type' => 'Pertanian',
                ],
                'agen_id' => (object) [
                    'id' => 3,
                    'first_name' => 'Tono',
                ...
                'reason' => 'Permintaan pickup untuk bahan baku industri.',
                'status' => 'Diterima',
            ],
            (object) [
                'id' => 4,
                ...
                'reason' => 'Permintaan pickup untuk pakaian dan aksesoris.',
                'status' => 'Diterima',
            ],
            (object) [
                'id' => 5,
                ...
                'reason' => 'Permintaan pickup untuk peralatan elektronik.',
                'status' => 'Ditolak',
            ],
            (object) [
                'id' => 6,
                'customer_umkm_id' => (object) [
                    'id' => 6,
                    'company_name' => 'Toko Segar Alam',
                    'product_type' => 'Buah dan Sayur',
                ],
                'agen_id' => (object) [
                    'id' => 6,
                    'first_name' => 'Rina',
                ...
                'reason' => 'Permintaan pickup untuk produk segar.',
                'status' => 'Ditolak',
            ],
        ];
    @endphp --}}
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin-hub-pickup.pickup-submission-history') }}"
                                    class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Riwayat
                                    Pengajuan Pickup</a>
                            </div>
                        </li>
                        <li>
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Riwayat Pengajuan Pickup
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form action="#" method="GET" class="hidden lg:block">
                        <label for="pickup-history-search" class="sr-only">Search</label>
                        <div class="relative lg:w-96">
                            ...
                            <input type="text" name="search" id="pickup-history-search"
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button type="button" data-modal-target="download-file-pickup-submission-history-modal"
                        data-modal-toggle="download-file-pickup-submission-history-modal"
                        class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-xs font-medium text-center text-gray-900 bg-white border border-gray-900 rounded-lg hover:text-white hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($riwayat_pengajuan_pickup as $reqpickup)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <div class="flex space-x-6 mr-10">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{ ucwords($reqpickup->customerUmkm->company_name) }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ ucwords($reqpickup->customerUmkm->product_type) }}
                                    </td>

                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ ucwords($reqpickup->agen->first_name . ' ' . $reqpickup->agen->last_name) }}
                                    </td>


                                    <td class="p-4 text-xs font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center">
                                            @if ($reqpickup->status === 'Diterima')
                                                <div class="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>
                                                <span>Diterima</span>
                                            @elseif ($reqpickup->status === 'Ditolak')
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-pickup-submission-history-modal-{{$reqpickup->id}}"
                                            data-modal-toggle="detail-pickup-submission-history-modal-{{$reqpickup->id}}"
                                        ...
                                        <!-- Detail pickup submission history Modal -->
                                        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                                            id="detail-pickup-submission-history-modal-{{$reqpickup->id}}">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                    ...
                                                    <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                                                        <h3 class="text-xl font-semibold dark:text-white">
                                                            Detail Riwayat Pengajuan Pickup Umkm
                                                        </h3>
                                                        <button type="button"
                                                    ...
                                                    <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                        @include('pages.admin-hub.pickup.riwayat-pengajuan-pickup.detail', ['data' => $reqpickup])
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                                                        <button type="button" data-modal-toggle="detail-pickup-submission-history-modal-{{$reqpickup->id}}"
                                        ...
                                        <button type="button" data-modal-target="delete-pickup-submission-history-modal"
                                            data-modal-toggle="delete-pickup-submission-history-modal"
                                            class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
    ...
    @include('components.pagination',['paginator' => $riwayat_pengajuan_pickup])

    <!-- Delete reqpickup Modal -->
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="delete-pickup-submission-history-modal">
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="delete-pickup-submission-history-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus riwayat pengajuan ini?</h3>
                    <a href="#"
                    ...
                    <a href="#"
                        ...
                        data-modal-hide="delete-reqpickup-modal">
                        No, cancel
                    </a>
                </div>
            </div>
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto h-modal sm:h-full"
        id="download-file-pickup-submission-history-modal">
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-pickup-submission-history-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
