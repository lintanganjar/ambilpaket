...
@section('content')
        ...
        $dataList = [
            ...
            (object) [
                ...
                'customer_id' => (object) [
                    ...
                    'first_name' => 'Jane',
                    'last_name' => 'Smith',
                    'full_address' => '78 Birch Lane, City C',
                    'province' => (object) [
                        'id' => 2,
                        'name' => 'Jawa Barat',
                    ],
                ...
                'amount' => 1,
                'note' => 'Barang dibutuhkan untuk promosi toko.',
            ],
            (object) [
                'id' => 3,
                'merchandise_id' => (object) [
                ...
                'customer_id' => (object) [
                    ...
                    'first_name' => 'Michael',
                    'last_name' => 'Tan',
                    'full_address' => '12 Oak Avenue, City D',
                    'province' => (object) [
                        'id' => 3,
                        'name' => 'Jawa Timur',
                    ],
                ...
                'amount' => 5,
                'note' => 'Permintaan khusus pelanggan loyal.',
            ],
            (object) [
                'id' => 4,
                'merchandise_id' => (object) [
                ...
                'customer_id' => (object) [
                    ...
                    'first_name' => 'Alice',
                    'last_name' => 'Brown',
                    'full_address' => '67 Pine Street, City E',
                    'province' => (object) [
                        'id' => 4,
                        'name' => 'Bali',
                    ],
                ...
                'amount' => 2,
                'note' => 'Digunakan untuk acara kantor.',
            ],
            (object) [
                'id' => 5,
                'merchandise_id' => (object) [
                ...
                'customer_id' => (object) [
                    ...
                    'first_name' => 'Chris',
                    'last_name' => 'Evans',
                    'full_address' => '101 Cedar Road, City F',
                    'province' => (object) [
                        'id' => 5,
                        'name' => 'Jawa Tengah',
                    ],
                ...
                'amount' => 4,
                'note' => 'Merchandise untuk acara komunitas.',
            ],
        ];
    @endphp --}}
    <div
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('admin-hub-merch.merch-stock') }}"
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Permintaan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Permintaan Merchandise
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form action="" method="GET" class="hidden lg:block">
                        <label for="merch-waitinglist-search" class="sr-only">Search</label>
                        <div class="relative lg:w-96">
                            ...
                            <input type="text" name="search" id="merch-waitinglist-search"
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                        <button type="button" data-modal-target="add-merch-waiting-list-modal"
                            data-modal-toggle="add-merch-waiting-list-modal"
                        ...
                        <button type="button" data-modal-target="download-file-merch-waiting-list-modal"
                            data-modal-toggle="download-file-merch-waiting-list-modal"
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @forelse ($merch_request as $merch)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex items-center space-x-6">
                                            <img class="w-10 h-10 rounded-full hidden lg:block md:block"
                                                src="{{ asset('static/images/users/' . $merch->merchandise->merchandise_img) }}"
                                                alt="avatar">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{ ucwords($merch->merchandise->name) }}
                                                </div>
                                    ...
                                    <td class="items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <div class="flex space-x-6 mr-10">
                                            <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                <div class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    {{$merch->user->customer ? ucwords($merch->user->customer->first_name . ' ' . $merch->user->customer->last_name): 'anonim'}}
                                                </div>
                                                <div class="text-xs font-normal text-gray-900 dark:text-white">
                                                    {{$merch->user->customer ? ucwords($merch->user->customer->district->name . ', ' . $merch->user->customer->regency->name . ', ' . $merch->user->customer->province->name . ', ' . $merch->user->customer->full_address) : '' }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="p-4 text-xs font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ ucwords($merch->amount . ' Pcs') }}
                                    </td>

                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-merch-waiting-list-modal"
                                            data-modal-toggle="detail-merch-waiting-list-modal"
                                        ...
                                        <button type="button" data-modal-target="delete-merch-waiting-list-modal"
                                            data-modal-toggle="delete-merch-waiting-list-modal"
                            ...
                            @empty
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td colspan="5" class="p-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">
    ...
    @include('components.pagination', ['paginator' => $merch_request])

    <!-- Detail merch waiting list Modal -->
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="detail-merch-waiting-list-modal">
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.admin-hub.merch.waiting-list.detail')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                    <button type="button" id="edit-btn" data-modal-id="detail-merch-waiting-list-modal"
                    ...
                    <button type="button" id="close-btn" data-modal-toggle="detail-merch-waiting-list-modal"
                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                    ...
                    <button type="button" id="cancel-btn" data-modal-id="detail-merch-waiting-list-modal"
    ...
    <!-- Add merch waiting list Modal -->
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="add-merch-waiting-list-modal">
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                <!-- Modal header -->
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.admin-hub.merch.waiting-list.add-form')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                    ...
                    <button type="button" data-modal-toggle="add-merch-waiting-list-modal"
                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-red-600 border border-red-600 rounded-lg hover:text-white hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:text-white dark:border-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                        <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Delete merch Modal -->
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="delete-merch-waiting-list-modal">
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="delete-merch-waiting-list-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus permintaan ini?
                      </h3>
                    <a href="#"
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto h-modal sm:h-full"
        id="download-file-merch-waiting-list-modal">
        <div class="relative w-full max-w-md px-4 h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                        data-modal-hide="download-file-merch-waiting-list-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                clip-rule="evenodd"></path>
