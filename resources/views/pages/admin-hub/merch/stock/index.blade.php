...
@section('content')
                            ...
                            @foreach ($merchData as $merch)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-target="detail-merch-stock-modal-{{$merch->id}}"
                                            data-modal-toggle="detail-merch-stock-modal-{{$merch->id}}"
                                        ...
                                        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                                            id="detail-merch-stock-modal-{{$merch->id}}">
                                            <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                    ...
                                                    <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                                                        @include('pages.admin-hub.merch.stock.detail' ,['data' => $merch])
                                                    </div>
                                                    <!-- Modal footer -->
                                                    <div
                                                        class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
                                                        <button type="button" id="edit-btn" data-modal-id="detail-merch-stock-modal-{{$merch->id}}"
                                                        ...
                                                        <button type="button" id="close-btn" data-modal-toggle="detail-merch-stock-modal-{{$merch->id}}"
    ...
    @include('components.pagination', ['paginator' => $merchData])
    {{-- <div
        ...
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    ...
                    @include('pages.admin-hub.merch.stock.add-form')
                </div>
                <!-- Modal footer -->
                <div
                    class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700 flex justify-end space-x-2">
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus stok 
                        merchandise ini?</h3>
                    <a href="#"
