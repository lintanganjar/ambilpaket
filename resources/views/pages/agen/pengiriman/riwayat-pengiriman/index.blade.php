@php
    $parcels = [
        ...
        (object) [
            ...
            'service_price_id' => 104,
            'estimation_date' => '2024-11-22',
            'proof_img' => '/images/proof_img2.png',
            'status' => 'Selesai',
        ],
    ];
@endphp
...
@section('content')
    <div class="p-4 bg-white dark:bg-gray-800 block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('pengiriman.riwayat-pengiriman') }}"
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua Riwayat Pengiriman
                </h1>
            </div>
            <div class="sm:flex">
        ...
        <div class="overflow-x-auto">
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-800 table-fixed">
                        <thead class="bg-gray-100 dark:bg-slate-800">
                            <tr>
                                <th scope="col" class="p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-all" aria-describedby="checkbox-1" type="checkbox"
                                            class="w-4 h-4 border-gray-300 rounded bg-gray-50 dark:bg-slate-700 focus:ring-3 focus:ring-primary-300">
                                        <label for="checkbox-all" class="sr-only">checkbox</label>
                                    </div>
                                </th>
                                <th scope="col"
                                    class="p-4 text-sm font-medium text-left text-gray-500 dark:text-gray-300 uppercase">
                                    Tanggal Pengiriman
                                </th>
                                <th scope="col"
                                    class="p-4 text-sm font-medium text-left text-gray-500 dark:text-gray-300 uppercase">
                        ...
                        <tbody class="bg-white divide-y dark:bg-slate-900 divide-gray-200">
                            @foreach ($parcels as $parcel)
                                <tr class="hover:bg-gray-100 dark:hover:bg-slate-700">
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input id="checkbox-{{ $parcel->id }}"
                                                aria-describedby="checkbox-{{ $parcel->id }}" type="checkbox"
                                                class="w-4 h-4 border-gray-300 rounded bg-gray-50 dark:bg-slate-700 focus:ring-3 focus:ring-primary-300">

                                            <label for="checkbox-{{ $parcel->id }}" class="sr-only">checkbox</label>
                                        </div>
                                    </td>
                                    <td class="p-4 text-xs font-medium text-black dark:text-white whitespace-nowrap">
                                        {{ $parcel->timeline->date }}</td>
                                    <td class="p-4 text-xs font-medium text-black dark:text-white whitespace-nowrap">
                                        {{ $parcel->customer_umkm_id->company_name }}</td>
                                    <td class="p-4 text-xs font-medium text-black dark:text-white whitespace-nowrap">
                                        {{ $parcel->customer_umkm_id->product_type }}</td>
                                    <td
                                        class="p-4 overflow-hidden text-xs font-medium text-black dark:text-white truncate ">
                                        {{ $parcel->status }}</td>
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        id="detail-pickup-submission-history-modal">
        <div class="relative w-full h-full max-w-4xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6 max-h-96 overflow-y-auto">
                    @include('pages.agen.pengiriman.riwayat-pengiriman.detail')
                </div>
                <!-- Modal footer -->
                <div
        ...
        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <h3 class="mt-5 mb-6 text-lg text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus riwayat pengiriman ini?</h3>
                    <a href="#"
