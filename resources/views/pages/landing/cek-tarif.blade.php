            ...
            <div class="flex flex-wrap gap-3 justify-center lg:justify-start">
                <div>
                    ...
                    <label for="all-filter"
                        class="inline-flex items-center justify-between w-full p-2 px-5 font-medium text-gray-700 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-white peer-checked:bg-customprimary-500 peer-checked:text-white hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="block">
        ...
        <div class="mt-5">
            <ul class="flex flex-col space-y-3 w-full">
                ...
                <li>
                    ...
                    <label for="service-{{ $servicePrice->id }}" class="block w-full p-4 text-gray-500 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-customprimary-500 peer-checked:border-2 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 text-center sm:text-left">
                            ...
                            <div class="font-medium">
                                <div class="text-sm text-gray-500 dark:text-white">Jenis Layanan</div>
                                <div class="text-sm text-gray-900 dark:text-white">{{ $servicePrice->service_type->name }}</div>
                            </div>
                            <div class="font-medium">
                                <div class="text-sm text-gray-500 dark:text-white">Estimasi Pengiriman</div>
                                <div class="text-sm text-gray-900 dark:text-white">2-3 Hari</div>
                            </div>
                            <div class="font-medium">
                                <div class="text-sm text-gray-500 dark:text-white">Harga</div>
                                <div class="text-sm text-gray-900 dark:text-white">Rp. {{ number_format($servicePrice->price, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    </label>
                </li>
