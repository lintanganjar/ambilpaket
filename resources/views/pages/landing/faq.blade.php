...
@section('content')
    ...
    <section class="bg-center bg-no-repeat bg-cover bg-blend-multiply"
        ...
        <div class="absolute w-full top-96 py-32 lg:py-32">
            <div class="mx-6 md:mx-12 lg:mx-20 xl:mx-36 py-6 lg:py-20 bg-white rounded-xl dark:bg-gray-800 dark:border-gray-700">
    ...
    <section class="bg-gray-100 dark:bg-gray-900 mt-12 lg:mt-32">
        <div class="px-6 md:px-12 lg:px-20 xl:px-36 w-full gap-8 py-8 mx-auto lg:gap-12 lg:grid lg:grid-cols-3 lg:py-16 items-start">
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
                <h2 class="lg:mb-3 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Mengapa harus
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
                <h2 class="lg:mb-3 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Apa saja keuntungan
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
                <h2 class="lg:mb-3 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Bagaimana mencetak
                    label atau resi?</h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm lg:text-base text-left">
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
                <h2 class="lg:mb-3 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Panduan penggunaan
                    AmbilPaket.com?
                </h2>
                <p class="text-gray-500 dark:text-gray-400 text-sm lg:text-base text-left">
            ...
            <div class="rounded-lg dark:bg-gray-800  flex flex-col mb-4 lg:mb-0">
                <h2 class="lg:mb-3 text-lg lg:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Bagaimana cara daftar
